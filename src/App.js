...
const App = () => {
  ...
  return (
    <div className='w-full h-screen bg-gradientBg bg-no-repeat bg-cover flex flex-col 
      ...
      {errorMsg && (
        <div className='w-full max-w-[90px] lg:max-w-[450px] bg-[#ff208c] text-white 
      ...
      >
        <div className='h-full relative flex items-center justify-center p-2'>
          <input
            ...
            type='text'
            placeholder='Search by city or contry'
          />
          <button
            onClick={(e) => handleSubmit(e)}
            className='bg-[#1ab8ed] hover:bg-[#12abdd] w-20 h-12 rounded-full flex 
